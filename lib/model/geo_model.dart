class ApiGeoLocation {
  ...
  factory ApiGeoLocation.fromJson(Map<String, Object?> json) => ApiGeoLocation(
        ...
        currency: json["currency"] != null
            ? CurrencyModel.fromJson(json["currency"] as Map<String, Object?>)
            : null,
...
class TimeZone {
  ...
  factory TimeZone.fromJson(Map<String, Object?> json) => TimeZone(
        ...
        offset: json["offset"] != null ? json["offset"] as int? : null,
        offset_with_dst: json["offset_with_dst"] != null
            ? json["offset_with_dst"] as int?
            : null,
        current_time: json["current_time"] != null
            ? json["current_time"] as String?
            : null,
        current_time_unix: json["current_time_unix"] as double?,
        is_dst: json["is_dst"] != null ? json["is_dst"] as bool? : null,
        dst_savings:
            json["dst_savings"] != null ? json["dst_savings"] as int? : null,
      );
